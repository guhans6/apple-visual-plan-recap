  ...
  return `<section class="doc-block" data-plan-section-id="ui-implementation-map">
    ...
    <div class="file-map-preview" data-plan-tabs>
      <div class="file-list" role="tablist" aria-label="Implementation tabs">
        <button class="file-tab is-active" type="button" data-tab-target="ui-file-plan-page"><strong>CompanionArtifactEditor.tsx</strong><span>Companion artifact reader and local review shell</span></button>
