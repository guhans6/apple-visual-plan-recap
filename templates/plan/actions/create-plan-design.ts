...
export default defineAction({
  ...
  mcpApp: {
    ...
    resource: embedApp({
      title: "Plan Design",
      description:
        "Open the Visual Companion design review surface for full-fidelity screens, prototype behavior, comments, and implementation notes.",
  ...
  run: async (args) => {
    ...
    return {
      ...
      fallbackInstructions:
        "Open the companion design artifact, review the full-fidelity Design tab first, click through the Prototype tab when present, add comments or targeted style edits, then read the pending companion feedback queue before continuing.",
    };
  },
  link: ({ result }) => {
