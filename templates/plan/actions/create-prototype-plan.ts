...
export default defineAction({
  ...
  mcpApp: {
    ...
    resource: embedApp({
      title: "Visual Plan",
      description:
        "Open the Visual Companion prototype review surface for functional states, comments, static mocks, and implementation notes.",
  ...
  run: async (args) => {
    ...
    return {
      ...
      fallbackInstructions:
        "Open the companion prototype artifact, click through the prototype states, add comments directly on the live prototype or static mocks, then read the pending companion feedback queue before continuing. Use the prototype popout for a focused browser review.",
    };
  },
  link: ({ result }) => {
