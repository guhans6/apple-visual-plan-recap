...
export default defineAction({
  description:
    "Read a Visual Companion artifact as source-control friendly MDX files. Returns plan.mdx, canvas.mdx when the artifact has a board, optional .plan-state.json, and the normalized JSON runtime model.",
  schema: z.object({
