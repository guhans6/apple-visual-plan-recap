...
export default defineAction({
  description:
    "Navigate the Visual Companion UI to the dashboard or a specific visual artifact.",
  schema: z.object({
    view: z
    ...
    localPlanSlug: z
      ...
      .optional()
      .describe(
        "Local MDX companion folder slug to open under /companion/plans/:slug or /companion/recaps/:slug",
      ),
    localPlanPath: z
      .string()
      .optional()
